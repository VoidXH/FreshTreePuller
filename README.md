# FreshTreePuller
Downloads all files from an FTP server after a given date and time. This is also an extremely lightweight FTP browser and downloader made for .NET 5, but should only be used for its intended purpose.
